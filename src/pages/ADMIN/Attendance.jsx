...
//               <tr key={rec._id}>
//                 <td className="px-6 py-4 text-sm text-gray-800">{rec.rollNumber}</td>
//                 <td className="px-6 py-4 text-sm text-gray-800">{rec.name}</td>
//                 <td className="px-6 py-4 text-sm text-gray-800">{rec.type}</td>
//                 <td className="px-6 py-4 text-sm text-gray-800">{rec.class || "-"}</td>
//                 <td className="px-6 py-4 text-sm text-gray-800">{rec.date}</td>
//                 <td className="px-6 py-4 text-sm text-gray-800">{rec.status}</td>
